...
const SEO = ({ description, meta, title, noIndex }) => {
  ...
  return (
    <Head>
      ...
      <link
        ...
        sizes="144x144"
        href="/icons/mask-144x144.png"
      />
      <link
        rel="apple-touch-icon"
        sizes="192x192"
        href="/icons/mask-192x192.png"
      />
      <link
        rel="apple-touch-icon"
        sizes="256x256"
        href="/icons/mask-256x256.png"
      />
      <link
        rel="apple-touch-icon"
        sizes="384x384"
        href="/icons/mask-384x384.png"
      />
      <link
        rel="apple-touch-icon"
        sizes="512x512"
        href="/icons/mask-512x512.png"
      />
